...
typedef enum
{
    CELLULAR_EDRX_CYCLE_0 = 0,      // Set the edrx cycle(5.12sec)
    CELLULAR_EDRX_CYCLE_1 = 1,      // Set the edrx cycle(10.24sec)
    CELLULAR_EDRX_CYCLE_2 = 2,      // Set the edrx cycle(20.48sec)
    CELLULAR_EDRX_CYCLE_3 = 3,      // Set the edrx cycle(40.96sec)
    CELLULAR_EDRX_CYCLE_4 = 4,      // Set the edrx cycle(61.44sec)
    CELLULAR_EDRX_CYCLE_5 = 5,      // Set the edrx cycle(81.92sec)
    CELLULAR_EDRX_CYCLE_6 = 6,      // Set the edrx cycle(102.40sec)
    CELLULAR_EDRX_CYCLE_7 = 7,      // Set the edrx cycle(122.88sec)
    CELLULAR_EDRX_CYCLE_8 = 8,      // Set the edrx cycle(143.36sec)
    CELLULAR_EDRX_CYCLE_9 = 9,      // Set the edrx cycle(163.84sec)
    CELLULAR_EDRX_CYCLE_10 = 10,    // Set the edrx cycle(327.68sec)
    CELLULAR_EDRX_CYCLE_11 = 11,    // Set the edrx cycle(655.36sec)
    CELLULAR_EDRX_CYCLE_12 = 12,    // Set the edrx cycle(1,310.72sec)
    CELLULAR_EDRX_CYCLE_13 = 13,    // Set the edrx cycle(2,621.44sec)
    CELLULAR_EDRX_CYCLE_14 = 14,    // Set the edrx cycle(5,242.88sec)
    CELLULAR_EDRX_CYCLE_15 = 15,    // Set the edrx cycle(10,485.76sec)
...
typedef enum
{
    CELLULAR_PSM_CYCLE_0 = 0,   // TAU cycle(10min) , Active time(2sec)
    CELLULAR_PSM_CYCLE_1 = 1,   // TAU cycle(1hour) , Active time(1min)
    CELLULAR_PSM_CYCLE_2 = 2,   // TAU cycle(10hour) , Active time(6min)
    CELLULAR_PSM_CYCLE_3 = 3,   // TAU cycle(2sec) , Active time(Timer is deactivated)
    CELLULAR_PSM_CYCLE_4 = 4,   // TAU cycle(30sec) , Active time(unavailable)
    CELLULAR_PSM_CYCLE_5 = 5,   // TAU cycle(1min) , Active time(unavailable)
    CELLULAR_PSM_CYCLE_6 = 6,   // TAU cycle(320hour) , Active time(unavailable)
    CELLULAR_PSM_CYCLE_7 = 7,   // TAU cycle(Timer is deactivated) , Active time(unavailable)
} e_cellular_psm_cycle_t;
