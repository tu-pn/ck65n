var NAVTREE =
[
  [ "Low Power Assistant Middleware Library 3.0.0", "index.html", [
    ...
    [ "Part 1. MCU Low Power", "index.html#group_lpa_p1", [
      [ "Quick Start Guide", "index.html#group_lpa_p1_qsg_general", [
        [ "MBEDOS", "index.html#group_lpa_p1_qsg", null ],
        [ "FREERTOS", "index.html#group_lpa_p1_qsg_anycloud", null ],
        [ "AFR", "index.html#group_lpa_p1_qsg_afr", null ]
      ] ],
    ...
    [ "Part 2. Wi-Fi Low Power", "index.html#group_lpa_p2", [
      [ "Wi-Fi Host-wake Signal", "index.html#group_lpa_p2_host_wake", [
        [ "Quick Start Guide", "index.html#group_lpa_p2_host_wake_qsg", [
          [ "MBEDOS", "index.html#group_lpa_p2_host_wake_qsg_mbedos", null ],
          [ "FREERTOS", "index.html#group_lpa_p2_host_wake_qsg_anycloud", null ],
          [ "AFR", "index.html#group_lpa_p2_host_wake_qsg_afr", null ]
        ] ]
      ] ],
      [ "Wi-Fi Address Resolution Protocol (ARP) Offload", "index.html#group_lpa_p2_arp_offload", [
        ...
        [ "Quick Start Guide", "index.html#group_lpa_p2_arp_offload_qsg", [
          [ "MBEDOS", "index.html#group_lpa_p2_arp_offload_qsg_mbedos", null ],
          [ "FREERTOS", "index.html#group_lpa_p2_arp_offload_qsg_anycloud", null ],
          [ "AFR", "index.html#group_lpa_p2_arp_offload_qsg_afr", null ]
        ] ]
      ] ],
      [ "Wi-Fi Packet Filter Offload", "index.html#group_lpa_p2_packet_filter", [
        ...
        [ "Quick Start Guide", "index.html#group_lpa_p2_packet_filter_qsg", [
          [ "MBEDOS", "index.html#group_lpa_p2_pf_offload_qsg_mbedos", null ],
          [ "FREERTOS", "index.html#group_lpa_p2_pf_offload_qsg_anycloud", null ],
          [ "AFR", "index.html#group_lpa_p2_pf_offload_qsg_afr", null ]
        ] ]
      ] ],
      [ "Wi-Fi TCP Keep Alive Offload", "index.html#group_lpa_p2_tcp_keepalive", [
        [ "Quick Start Guide", "index.html#group_lpa_p2_tcp_keepalive_qsg", [
          [ "MBEDOS", "index.html#group_lpa_p2_tcp_keepalive_qsg_mbedos", null ],
          [ "FREERTOS", "index.html#group_lpa_p2_tcp_keepalive_qsg_anycloud", null ],
          [ "AFR", "index.html#group_lpa_p2_tcp_keepalive_qsg_afr", null ]
        ] ]
      ] ],
    ...
    [ "Part 3. Bluetooth Low Power", "index.html#group_lpa_p3", [
      [ "Quick Start Guide", "index.html#group_lpa_p3_qsg", [
        [ "MBEDOS", "index.html#group_lpa_p3_qsg_mbedos", null ],
        [ "FREERTOS", "index.html#group_lpa_p3_qsg_anycloud", null ],
        [ "AFR", "index.html#group_lpa_p3_qsg_afr", null ]
      ] ],
    ...
    [ "Performance Data", "index.html#section_lpa_performance", null ],
    ...
    [ "Changelog", "index.html#group_lpa_changelog", null ],
    [ "More Information", "index.html#section_lpa_more_information", null ],
    [ "LPA API", "index.html#apis", [
      [ "Utilities", "index.html#section_apis", null ]
    ] ]
  ] ]
];
